...
```
Este documento presenta información adicional para conocer con mayor detalle el proyecto de investigación. En general se ha seguido la plantilla de preinscripción de [AsPredicted.org](https://aspredicted.org/), añadiendo un resumen del proyecto y una descripción de las variables independientes.
...
$H_6$: La heterogeneidad socioeconómica del contexto escolar afecta negativamente las creencias meritocraticas
...
$H_10$: La heterogeneidad socioeconómica del contexto escolar puede potenciar el efecto del nivel socioeconómico de la familia sobre la sensación de justicia en las notas.
...
Acá escribir descripción variable nivel dos.
